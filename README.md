...
From Game Theory, emerged `The Prisoner's Dilemma` which is an actual game that you can play.

With sovereignty\_, you just follow a few steps (extra care on the docs), and then you can play.
